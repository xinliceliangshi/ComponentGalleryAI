...
SECOND_ATTEMPT_PAYLOAD: dict[str, Any] = {
    "components": [
        {"name": "ZhDescriptions", "usage": "展示详情基础信息"},
        {"name": "ZhButtonGroup", "usage": "承载状态相关操作"},
    ],
    "explanation": "页面由头部、基础信息和操作区组成。",
    "code": "export default { name: 'GoodsAuditDetailPage' };",
    "tips": ["把状态映射统一放进 statusConfig"],
