import { adminEditPageTypeCases, type PageTypeCase } from "./admin-edit-page-type-cases.js";

export type { PageTypeCase } from "./admin-edit-page-type-cases.js";

export const pageTypeCases: PageTypeCase[] = [
